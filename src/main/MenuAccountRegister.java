...
public class MenuAccountRegister implements GUI {
    ...
    public MenuAccountRegister(int sizeX, int sizeY)
    {
        updateCounter = 0;
        ...
        {
            //Parent test;
            test = FXMLLoader.load(getClass().getResource("ui/MenuRegister.fxml"));
            //Stage stage = new Stage();
